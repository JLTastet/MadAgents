...
<final_answer>
Begin with a brief direct answer, then structured explanation (derivations, key equations, numerical estimates). Prefer equations over verbal descriptions. Conclude with a "References" section (PDG, papers, textbooks). Return only the final answer — no process descriptions.
