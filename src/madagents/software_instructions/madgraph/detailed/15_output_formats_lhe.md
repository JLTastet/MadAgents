...
MadGraph produces events in the Les Houches Event (LHE) format, an XML-based standard for parton-level Monte Carlo events. Understanding the LHE format is essential for parsing events, extracting cross-sections, and computing observables.
...
```
<PROC_DIR>/Events/run_01/unweighted_events.lhe.gz
```
...
The weight IDs map to specific scale/PDF combinations. See [Systematics & Reweighting](13_systematics_reweighting.md).
...
| PDG ID | Particle | |PDG ID | Particle |
|--------|----------|-|--------|----------|
| 1 | d (down) | | -1 | d̄ |
| 2 | u (up) | | -2 | ū |
| 3 | s (strange) | | -3 | s̄ |
...
File locations: see [Scripted Execution](05_scripted_execution.md) for the output directory structure.

## Cross-References

- **[← Reference: Shower, Detector & Analysis](shower_detector_analysis.md)**
- [Scripted Execution](05_scripted_execution.md) — output directory structure
- [Systematics & Reweighting](13_systematics_reweighting.md) — `<rwgt>` blocks
- [Decays & MadSpin](08_decays_and_madspin.md) — intermediate particles in LHE
- [Parton Shower — Pythia8](09_parton_shower_pythia8.md) — HepMC output
- [Detector Simulation — Delphes](10_detector_simulation_delphes.md) — ROOT output
- [Troubleshooting](16_troubleshooting.md) — weighted vs unweighted events
- [Analysis — MadAnalysis5](11_analysis_madanalysis5.md) — analyzing LHE and ROOT output
- [Biased Event Generation](24_biased_event_generation.md) — weighted events from bias modules
