...
See also: [NLO Computations](06_nlo_computations.md) — general NLO requirements and pitfalls

## Cross-References

- **[← Reference: Production & Troubleshooting](production_and_troubleshooting.md)**
- [Cards & Parameters](04_cards_and_parameters.md) — run_card beam parameters
- [PDFs and LHAPDF](19_pdfs_and_lhapdf.md) — PDF selection for different beam types
- [Scripted Execution](05_scripted_execution.md) — complete script examples
- [Advanced Syntax](17_advanced_syntax.md) — polarized final-state particles (separate from beam polarization)
