...
- [Cards & Parameters](04_cards_and_parameters.md) — `bias_module`, `bias_parameters` in run_card
- [Output Formats & LHE](15_output_formats_lhe.md) — event weights in LHE files
- [Scripted Execution](05_scripted_execution.md) — integrating bias into scripts
