...
- [Models](03_models.md) — model loading, restriction files, BSM workflow
- [Advanced Syntax](17_advanced_syntax.md) — coupling order syntax, `^2` squared orders
- [Cards & Parameters](04_cards_and_parameters.md) — param_card editing
- [Systematics & Reweighting](13_systematics_reweighting.md) — parameter scans over Wilson coefficients
- [Scripted Execution](05_scripted_execution.md) — batch generation scripts
